...
void keyPress()
{
	...
	//X AXIS TRANSLATION
	if(keydown(GLFW_KEY_I))modelX += 1.5;
	if(keydown(GLFW_KEY_J))modelX -= 1.5;
	//Y AXIS TRANSLATION
	if(keydown(GLFW_KEY_O))modelY += 1.5;
	if(keydown(GLFW_KEY_K))modelY -= 1.5;
	//Z AXIS TRANSLATION
	if(keydown(GLFW_KEY_P))modelZ += 1.5;
	if(keydown(GLFW_KEY_L))modelZ -= 1.5;
	//EULER X ROTATION
	if(keydown(GLFW_KEY_1))rotX += 3;
	if(keydown(GLFW_KEY_2))rotX -= 3;
	//EULER Y ROTATION
	if(keydown(GLFW_KEY_3))rotY += 3;
	if(keydown(GLFW_KEY_4))rotY -= 3;
	//EULER Z ROTATION
	if(keydown(GLFW_KEY_5))rotZ += 3;
	if(keydown(GLFW_KEY_6))rotZ -= 3;
	//X AXIS SCALING
