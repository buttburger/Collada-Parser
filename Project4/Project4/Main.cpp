...
float eyeX = 0, eyeY = 0, eyeZ = 3;//Initial position : on +Z
...
GLuint uniformModel[10], uniformView[10], uniformProjection[10];


char loadmodel[] = "cube.obj", loadmodel1[] = "dummy.dae", loadmodel2[] = "test1.fbx";
char loadtexture[] = "texture.png", loadtexture1[] = "texture1.png", loadtexture2[] = "texture2.png";


char DAEfile[] = "dummy.dae";
char DAEtexture[] = "dae.png";
